...
const category ="Baby's & Toys"
  useEffect( () => {
    const fetchData=async(category)=>{
       await axios.get(`http://localhost:3000/api/productss/product/:${category}`)
       .then((res)=>
       {setData(res.data)})
  ...
  return (
    <div style={{ width: "100%", height: "100%", borderTop: "1px solid black", boxShadow: 4 }}>
      <div style={{ width: "100%", display: "flex" }}>
        <h1 style={{ marginTop: 60, marginLeft: 40, borderBottom: 1 }}>Baby's & Toys</h1>
      </div>
